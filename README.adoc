...
== Bootstrapping a Vaccination Scheduling Runtime
...
Different seed data can be made available to the planning engine via the following property:  `com.redhat.vaccination.scheduling.seed.file.path`
